...
\begin{proof}
  ...
  \begin{itemize} %TODO Input-Schleifen entfernen, da sonst durch
    ...
    \item Fall 1 ($w=\varepsilon$): Es ist ein Ruhe-Zustand lokal erreichbar in
      ...
      aus dem Startzustand ohne Tranistionsmöglichkeiten besteht. Somit ist
      ...
      Transitionsnen möglich sind, kann nur $\varepsilon$ ein strikter
