...
\label{UepsQET}
      \end{center}
      \end{figure}
      Es ist somit ebenfalls in $U$ ein Ruhe-Zustand intern erreichbar.
      Zusätzlich wird durch den Aufbau von $U$ verhindert, dass neue Errors in
      der Komposition entstehen können. Damit folgt mit dem ersten Punkt von
      ...
      relevant. Da in $U$ nur durch $\varepsilon$ ein Ruhezustand erreichbar
      ist, kann nur
...
\label{UohneEmitI}
      ...
      Es gilt wegen des ersten Punktes von Lemma~\ref{lemRuheParallelkomp}, dass auch in der
