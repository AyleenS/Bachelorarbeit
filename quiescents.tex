  ...
  \begin{center}
    \begin{tikzpicture}
      \matrix (m) [matrix of math nodes,row sep=3em,column sep=4em,minimum width=2em]{
        ...
        \forall~\mathrm{Partner}~U:U\|S_1\QBRel U\|S_2 &
        \forall~\mathrm{komponierbaren}~U:U\|S_1\QBRel U\|S_2 \\};
        \path[-stealth]
          ...
          (m-2-1) edge [double,semithick] node [left] {Lemma~\ref{lemQuiVerfeinerung}} (m-1-1)
          (m-2-2) edge [double,semithick] node [below] {$U$ Partner $\Rightarrow U$ komponierbar} (m-2-1);
    \end{tikzpicture}
