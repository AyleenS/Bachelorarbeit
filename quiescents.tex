...
optimistischen Ansatz der lokalen Erreichbarkeit für die Errors. Da Ruhe keine
unabwendbaren Fehler sein müssen, sondern durch einen
...
Hiding neue Ruhe-Zustände entstehen können. Die neue Menge der
Ruhe-Zustände sieht dann wie folgt aus: $Qui/\{x_1,x_2,\dots ,x_n\}=\{q\in
  Q\mid q \overset{x}{\rightarrow}\wedge \; x\in \{x_1,x_2,\dots ,x_n\}\wedge
\forall \alpha\in (O\cup\{\tau\})\backslash\{x_1,x_x,\dots ,x_n\}: q
