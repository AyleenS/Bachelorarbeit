...
wird hier zunächst nicht betrachten.\\
Die Zustände, die keine Outputs und keine Transitionsmöglichkeit für
eine interne Aktion haben werden als ruhig angesehen.
...
Fehler\grqq{} anzusehen wie ein Error. Somit ist ein Ruhe-Zustand im
...
\begin{Def}[Ruhe-Verfeinerungs-Basisrelation]
  ...
  $S_1\QBRel S_2$ geschrieben, wenn ein Error oder Ruhe-Zustand in $S_1$ nur dann lokal
...
Wie bereits oben erwähnt, wird die Erreichbarkeit der Ruhe-Zustände nicht
auf die gleiche Weise umsetzten, wie bei Errortraces, somit werden keine
gekürzten Ruhetraces benötigt, bei der die \prune{}-Funktion zur Anwendung käme.
...
gefluteten Sprache \EL{} enthalten wären, muss hier keine neue Flutung
vornehmen werden. Es wird also durch die Relation \QRel{} nur die
