...
repariert werden. Daraus ergibt sich, dass Ruhe als nicht so
\glqq{}schlimmer Fehler\grqq{} anzusehen ist wie Error. Somit ist ein
...
zu Error-Zuständen. Somit werden keine gekürzten Ruhetraces benötigt, bei denen die
...
\begin{proof}
  ...
  (ii),
  durch Ersetzen von $\tau$s durch Outputs aus $X$ im jeweiligen Ablauf ein Ablauf gefunden werden,
