...
\begin{proof}
  ...
  zusammengesetzte Zustand haben und könnte somit nach unserer Definition
...
\begin{proof}
  ...
  Hier müssen wir unterscheiden ob wir ein $w\in\StQT{}_{12}\backslash
  \ET{}_{12}$ betrachten oder ein $w\in \ET{}_{12}$. Im zweiten Fall ist das
  $w$ in der rechten Seite enthalten. Somit betrachten wir ab jetzt ein $w\in
  \StQT{}_{12}\backslash \ET{}_{12}$ und versuchen dessen Zugehörigkeit zur
  rechten Menge zu zeigen. Aufgrund von Definition~\ref{DefRuhetraces} wissen
  wir, dass $(q_{01},q_{02}) \overset{w}{\Rightarrow} (q_1,q_2)$ gilt mit
  $(q_1,q_2)\in Qui_{12}$. Durch Projektion erhalten wir $q_{01}
  \overset{w_1}{\Rightarrow} q_1$ und $q_{02} \overset{w_2}{\Rightarrow} q_2$
  mit $w\in w_1\|w_2$. Aus $(q_1,q_2)\in Qui_{12}$ können wir mit Punkt 2.\ von
  Lemma~\ref{lemRuheParallelkomp} folgern, dass bereits $q_1\in Qui_1$ und
