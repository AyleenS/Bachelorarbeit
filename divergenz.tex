...
ist $q_{01}$ kein Divergenz-Zustand. Bei $S_2$ ist der Startzustand
durch
...
\begin{Def}[alternative Divergenz-Verfeinerungs-Basisrelation]
  ...
  \DCaRel{} bezeichnet die \emph{vollständig abstrakte Präkongruenz} von \DBaRel{}
  bezüglich $\cdot\|\cdot$.
\end{Def}
...
\begin{Def}[alternative Charakterisierung der volltändig abstrakten Präkonrugenz]
