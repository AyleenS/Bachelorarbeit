...
\begin{proof}
  %TODO an Div Definitionen anpassen und bei erstem Teil Fehler rausarbeiten
  ...
  \begin{itemize}
    \item Fall 1 ($w=\varepsilon$): Es handelt sich um einen lokal erreichbaren
      ...
      \begin{itemize}
        ...
        \textcolor{red}{\item Fall 1b) $\varepsilon\in\DT{}(U\|S_2)\backslash\ET{}(U\|S_2)$):
          Da $U$ nicht unendliche viele Zustände hat und auch keine
          $\tau$-Schleifen besitzt, kann das divergenz Verhalten nur von $S_2$
          geerbt sein. Es muss also in $S_2$ ein Divergenz-Zustand lokal
          erreichbar sein und somit gilt $\varepsilon\in\PrDT{}_2\subseteq
        \DT{}_2$.\lightning}
      \end{itemize}
...
\label{UmitEundO}
      ...
      dass $w$ in $\EL{}_2$ enthalten ist. %TODO prüfen
  \end{itemize}
...
\label{UfuerDTmitO}
    ...
    Divergenz-Zustand erreichbar ist und $w$ nur aus synchonisierten Aktionen
    ...
    \begin{itemize}
      \item Fall 2a) ($\varepsilon\in \ET{}(U\|S_2)$): Der lokal erreichbare
        ...
        $wv$ in nicht ausführbar ist und es in der Parallelkomposition somit
        ...
        $U$ Fehler durch synchonisation möglich sind, bereits ein Präfix von
        $wv$ in $\ET{}_2$ enthalten und da $v\in O^*$ gilt, ist sogar ein
        Präfix von $w$ in $\ET{}_2$ enthalten. Somit gilt auch auch
        $w\in\ET{}_2 \subseteq \DT{}_2$, da \ET{} unter \cont{} abgeschlossen
        ist.
      \item Fall 2b) ($\varepsilon\in \PrDT{}(U\|S_2)\backslash
        \ET{}(U\|S_2)$): Es ist also nur ein divergenter Zustand in $U\|S_2$
        lokal erreichbar und kein Error. Da $U$ keine Divergenz-Möglichkeiten
        ...
        $S_2$ einen Zustand aus $Div _2$ erreichen. Es gilt dann $x_1\dots
        x_i\in \PrDT{}_2\subseteq\DT{}_2$, da $u|_{\Sigma _2}\in O^*$ gilt.
        $x_1\dots x_i$ ist ein Präfix von $wv$. Da $v\in O^*$ gilt, und \DT{}
        unter \cont{} abgeschlossen ist, gilt $w\in \DT{}_2$. %TODO über Verlängerung nachdenken
    \end{itemize}
  \end{itemize}
...
\label{UohneEmitIundO}
      ...
      \begin{itemize}
        \item Fall 2a) ($\varepsilon\in \DT{}(U\|S_2)$): Es handelt sich bei
          ...
          unter \cont{} abgeschlossen ist, gilt also auch $w\in
          \DT{}_2\subseteq \QT{}_2$.%TODO über Verlängerungen von DT nachdenken
