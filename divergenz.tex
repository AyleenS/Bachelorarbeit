...
Basisrelation \DBRel{}, obwohl in $U\|S_1$ nur ein Error-Zustand und in $U\|S_2$ nur
...
können sollten somit auch $S_1$ und $S_2$ in der Relation \DRel{} stehen. Dies
...
$S_1\DRel{} S_2$ nicht $S_1\ERel{} S_2$.
...
\label{UohneEmitO}
      ...
      \begin{itemize}
        ...
        \item Fall 2ii) ($\varepsilon\in\ET{}(U\|S_2)$ wegen geerbtem Error):
          ...
          diesem Fall ein Präfix von $w$ zu einem Error-Zustand und ist somit in
          $\EDT{}_2$ enthalten.
...
und man hätte zusätzlich die Inklusionen $\DT{}_1 \cup\ET{}_1 \subseteq \DT{}_2\cup
