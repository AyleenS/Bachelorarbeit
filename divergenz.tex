...
\begin{itemize}
  ...
  \item $U = \left(\{q_{0U}\}, \emptyset, \{\omega\}, \{(q_{0U},\omega ,q_{0U})\},
    q_{0U}, \emptyset \right)$ (siehe auch Abbildung~\ref{U}).
\end{itemize}
\begin{figure}[h!tbp]
...
\begin{itemize}
  \item $U\|S_1 =\left(\left\{\left(q_{0U},q_{01}\right)\right\},\emptyset
      ,\left\{\omega\right\}, \left\{\left(\left(q_{0U}, q_{01}\right),\omega
        ,\left(q_{0U},q_{01}\right)\right)\right\}, \left(q_{0U},
        q_{01}\right), \left\{\left(q_{0U},q_{01}\right)\right\}\right)$ (siehe
        auch Abbildung~\ref{US1}),
  \item $U\|S_2 =\left(\left\{\left(q_{0U},q_{02}\right)\right\},\emptyset
      ,\left\{\omega\right\}, \left\{\left(\left(q_{0U}, q_{02}\right),\omega
          ,\left(q_{0U},q_{02}\right)\right), \left(\left(q_{0U},q_{02}\right),
          \tau ,\left(q_{0U},q_{02}\right)\right)\right\},
          \left(q_{0U},\right.\right.$
        $\left.\left.q_{02}\right), \emptyset\right)$ (siehe auch Abbildung~\ref{US2}).
\end{itemize}
\begin{figure}[h!tbp]
