\documentclass[12pt,a4paper,oneside,ngerman,parskip=half*]{scrbook}
...
\newcommand{\prunenew}{\ensuremath{prune'}}
...
\newcommand{\DBRel}{\ensuremath{\sqsubseteq _{Div}^B}}
\newcommand{\DCRel}{\ensuremath{\sqsubseteq _{Div}^C}}
