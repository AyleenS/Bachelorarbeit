...
wirklich alle synchronisierten Aktionen verborgen. Falls das Internalisieren
vor der Komposition durchgeführt werden würde, wären im Gesamtsystem die
Aktionen aus $Synch(S_1,S_2)$ als Inputs alle vorhanden, da nur die Outputs
versteckt wurden.
