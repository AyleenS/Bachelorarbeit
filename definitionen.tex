...
Parallelkomposition die Input-Aktionen der Error-IO-Transitionssysteme (\EIO{}s) nicht disjunkt sein müssen. Dies
wäre eine unnötige Einschränkung. Die nicht synchronisierten Inputs der zu komponierenden \EIO{}s werden
als Inputs der Parallelkomposition übernommen. Zusätzlich verzichten wir hier
auf das verbergen der synchronisierten Aktionen. Die gleiche
...
Die Aktionsmenge eines \EIO{}s $S$ ist $\Sigma = I\cup O$ und die Signatur
$Sig(S)=(I,O)$.\\
...
\begin{Def}[Parallelkomposition]
  Zwei \EIO{}s $S_1, S_2$ sind komponierbar, falls
...
\end{aligned}\hspace{1cm}\right\}
  ...
  \end{aligned}$
  \end{itemize}
  Dabei werden die synchronisierten Aktionen $Synch(S_1,
