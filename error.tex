...
\begin{proof}
  ...
  \glqq $\Leftarrow$\grqq : Nach Definition gilt, wenn
      ...
      ist $S_1\ERel S_2$ eine Präkongurenz, die in \EBRel{} enthalten ist. Da
      \ECRel{} die gröbste Präkongurenz bezüglich $\cdot\|\cdot$ ist, die in
      \EBRel{} entahlten ist, muss \ERel{} in \ECRel{} enthalten sein. Es folgt
