...
\begin{proof}
  ...
  \begin{itemize}
    \item Fall 1a) ($a\in (I_1\cap I_2)$): Nun kann der Ablauf der
...
\label{UohneE}
      ...
      \begin{itemize}
        \item Fall 2a) ($w\in \MIT{}_1$): In $U\|S_1$ erhält man
          $(q_0,q_{01}) \overset{x_1\dots x_n}{\Longrightarrow} (q_n,q')$ mit
...
\label{UmitE}
      ...
      \begin{itemize}
        \item Fall 2a) (neuer Error aufgrund von $x_i\in O_U$ und $q_{02}
          \overset{x_1\dots x_{i-1}}{\Longrightarrow} q''
        ...
        \item Fall 2c) (geerbter Error von $U$): Da der einzige Zustand aus
          ...
          möglich, wenn gilt $q_{02} \overset{x_1\dots x_n}{\Longrightarrow}$. In
          diesem Fall gilt $w\in L_2\subseteq \EL{}_2$.
        \item Fall 2d) (geerbter Error von $S_2$): Es gilt dann $q_{02}
          \overset{x_1\dots x_iu}{\Longrightarrow} q'\in E_2$ für $i\geq 0$ und
