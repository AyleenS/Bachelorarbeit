...
%TODO Ringschlussanmerkung einbinden
...
\begin{prop}[Präkongurenz bzgl. Interalisierung]
  \label{propIntrPrae}
  Seien $S_1$ und $S_2$ zwei \EIO{}s   für   die   gilt $  S_1\  ERel   S_2$
  und sei $X:=\{x_1,x_2,\dots ,x_n\}= O_1 = O_2$, dann gilt auch
  $(S_1/X)\ERel (S_2/X)$. Somit ist also \ERel{} eine Präkongruenz bezüglich
  $\cdot /\cdot$.
\end{prop}
...
\begin{kor}[Präkongurenz bzgl. Präkongurenz mit Internalisierung]
  \ERel{} ist eine Präkongruenz bezüglich $|$.
\end{kor}
