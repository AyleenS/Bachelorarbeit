...
\begin{Def}[lokal errorfreie Kommunikation]
  ...
  Zwei \EIO{}s $S_1$ und $S_2$ kommunizieren gut, wenn in ihrer
...
\begin{Def}[lokale Basisrelation]
  ...
  \ECRel{} bezeichnet die vollständig abstrakte Präkongruenz von \EBRel{}
  bezüglich $\cdot\|\cdot$.
\end{Def}
...
\begin{proof}
  ...
  \begin{itemize}
    \item Fall 1a) ($a\in (I_1\cap I_2)$): Nun können wir den Ablauf der
      ...
      x_1\|x_2$. Daraus können wir $x_1a\in \cont{}(MIT_1)\subseteq \ET{}_1\subseteq
      \EL{}_1$ und $x_2a\in \EL{}_2$ ($x_2a\in MIT_2$ oder $x_2a\in L_2$) folgern. Damit folgt $w\in
  ...
  \item Fall 1b) ($a\in (I_1\cup I_2)\backslash(I_1\cap I_2)$): \OBdA{} gilt
      ...
      $x_1a\in \cont{}(MIT_1)\subseteq \ET{}_1$ und $x_2\in L_2\subseteq \EL{}_2$. Somit
  ...
  Sei $v_1$ das kürzeste Präfix von $w_1$ in $\\PrET{}_1\cup MIT_1$. Falls
  $w_2\in L_2$, so sei $v_2=w_2$, sonst soll $v_2$ das kürzeste Präfix von
  $w_2$ in $\\PrET{}_2\cup MIT_2$ sein. Jede Aktion in $v_1$ und $v_2$ hängt mit
  ...
  $v_2\in \\PrET{}_2\cup MIT_2$ vor $v_1$ und somit ist dieser Fall analog zu $v_1$
  endet vor $v_2$.
  \begin{itemize}
    ...
    \item Fall 2 ($v_1\neq\varepsilon$): Aufgrund der Definitionen von $\\PrET{}$
      ...
      \\PrET{}_2\cup MIT_2$ gilt, dann ist durch die Annahme, dass $v_2$ nicht vor
  ...
  \begin{itemize}
    \item Fall I ($v_1\in MIT_1$ und $v_1\neq\varepsilon$): Es gibt $q_{01}
      ...
      \begin{itemize}
        ...
        \item Fall Ib) ($a\in I_2$ und $v_2'\in MIT_2$): Es gilt $v_2'=v_2''a$
