...
\begin{proof}
  ...
  noch die Aktionen übrig, die nicht Element von $X$ sind. Der Trace reduziert
  sich also auf $w''=w|_{\Sigma\backslash
  ...
  Auswirkungen auf die Teilmengenbeziehung hat. %TODO ET(S/X) und EL(S/X)!!!
  %und daraus resultierende Abänderungen
\end{proof}
