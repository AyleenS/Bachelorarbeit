...
aus unser Struktur hervorheben. Die strikten Errortraces entsprechen Wegen, die
...
\begin{proof}
  ...
  \glqq $\Leftarrow$\grqq : Nach Definition gilt, wenn
      ...
      über die lokale Erreichbarkeit definiert wurde. Da \ECRel{} die gröbste
      Präkongurenz bezüglich $\cdot\|\cdot$ ist, die in \EBRel{} entahlten ist,
      muss für alle $S_1\ECRel{} S_2$ gelten, dass auch $S_1\|U\ECRel S_2\|U$
      gilt. Wenn $U$ nun das Transitionssystem ist, dass nur aus dem
      Startzustand besteht, der ein Error-Zustand ist, dann gilt für
      $\varepsilon\in S_i\|U$. Somit können wir also auch aus $S_1\ERel S_2$
      den relationalen Zusammenhang $S_1\ECRel S_2$ folgern. %TODO noch mal
      %drüber nachdenken
...
\begin{proof}
  ...
  zulässig sind. Um uns eine genauere Vorstellung davon machen zu können, was
  das Hiding für die Systeme bedeutet, definieren wir hier zunächst einmal die
  neuen Errortraces und die neue geflutete Sprache. Es gilt $\ET{}(S/X) =
  ...
  w\}$.\\
  Wir wählen einen Trace $w=a_1a_2\dots a_m\in \ET{}_1$. Solang $w$ nicht nur
  ...
  Präfix, da der Input $a_k$ erhalten beleibt. Dieses Präfix von $w''$ ist dann
  ...
  mindestens einen Input enthalten müssen, muss so ein $w$ aus
  ...
  $X$ gibt, werden in diesem Wort auch keine Aktionen verborgen und somit gilt
