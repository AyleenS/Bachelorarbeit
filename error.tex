...
\begin{proof}
  ...
  \begin{itemize}
    \item Fall 1a) ($a\in (I_1\cap I_2)$): Nun können wir den Ablauf der
      ...
      EL_1$ und $x_2\in EL_2$ folgern. Damit folgt $w\in
  ...
  \begin{itemize}
    \item Fall I ($v_1\in MIT_1$ und $v_1\neq\varepsilon$): Es gibt $q_{01}
      ...
      einen weiteren Fall (Ib)) einfügen, da es zulässig ist, das $a$ sowohl ein in
      ...
      \begin{itemize}
        ...
        \item Fall Ib) ($a\in I_2$): Es gilt $v_2'=v_2''a$ mit $q_{02}
          ...
          synchronisierten Handlungen bezüglich~\cite{Vogler2014EIO} erweitert
          ...
          \overset{a}{\not{\hspace{-0.1cm}\rightarrow}}$ gilt. Wir können also
