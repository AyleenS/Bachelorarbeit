  ...
  \begin{itemize}
    \item Fall I ($v_1\in MIT_1$ und $v_1\neq\varepsilon$): Es gibt $q_{01}
      ...
      \begin{itemize}
        ...
        \item Fall Ib) ($a\in O_2$): Es gilt $v_2'=v_2''a$. Durch (*) erhalten
          wir $q_{02} \overset{v_2''}{\Rightarrow} q_2
          \overset{a}{\rightarrow}$ mit $v''\in v_1'\|v_2'$. Daraus ergibt sich
          $(q_{01},q_{02}) \overset{v''}{\Rightarrow} (q_1,q_2)$ mit $q_1
          \overset{a}{\not{\hspace{-0.1cm}\rightarrow}}, a\in I_1, q_2 \overset
          {a}{\rightarrow}, a\in O_2$, somit gilt $(q_1,q_2)\in E_{12}$. Wir
          wählen $v:=prune (v'')\in PrET(S_1\|S_2)$.
        \item Fall Ic) ($a\in I_2$):
        % \item Fall Ib) ($a\in\Sigma _2$): Es folgt $a\in O_2$ und%TODO ausbessern kann auch a\in I_2 gelelten
